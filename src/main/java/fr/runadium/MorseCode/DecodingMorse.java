...
public class DecodingMorse {
	...
	private static String[]  lettersAndNumbers = { "1", "2", "3", "4",
	...
	public static String decodeMorse(String inputMorseCode) {
		return Arrays.stream(inputMorseCode.trim().split("   ")).map(e->DecodingMorse.findEquivalent(e)).collect(Collectors.joining(" "));
	}
